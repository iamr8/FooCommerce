...
public class CatalogManagerController : ControllerBase
{
    private readonly ICatalogManager _catalogManager;

    private readonly ILogger<CatalogManagerController> _logger;

    public CatalogManagerController(ICatalogManager catalogManager, ILogger<CatalogManagerController> logger)
    {
        _logger = logger;
