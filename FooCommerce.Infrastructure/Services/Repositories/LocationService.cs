...
public class LocationService : ILocationService
{
    ...
    private async Task<IEnumerable<LocationModel>> GetLocationsNonCachedAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<IEnumerable<LocationModel>> GetLocationsAsync(CancellationToken cancellationToken = default)
    {
        return await _cacheProvider.GetOrCreateAsync(CacheKey,
            async token => await GetLocationsNonCachedAsync(token),
