...
public class SendNotificationHandler : INotificationHandler<SendNotification>
{
    ...
    public SendNotificationHandler(INotificationTemplateService templateService,
        IMediator mediator,
    ...
    public async Task Handle(SendNotification notification, CancellationToken cancellationToken)
    {
        ...
        var templates = await _templateService.GetTemplateAsync(notification.Options.Action, cancellationToken);
